...
Public Class msgFactory : Implements IDisposable
    ...
    Private _Messages As Dictionary(Of String, msgInterface)
    Public Sub New(ByRef Messages As Dictionary(Of String, msgInterface))
        _Messages = Messages
...
#Region "Message Factory"
    ...
    Public Function EncodeRequest(msgtype As String, ob As objBase) As Byte()
        For Each msg As msgInterface In _Messages.Values
            With msg
