...
#Region "control panel"
    ...
    Public Overrides Function useCpl(ByRef o As Object, ParamArray args() As String) As Object
        Return New cplEventLogPage(TryCast(o, oSubEventLog))
        ...
        Select Case UBound(args)
            Case 1
                With TryCast(sender, ContextMenuStrip).Items
                    .Clear()
                    .Add("Stop subscriber", Nothing, AddressOf TryCast(p, oSubEventLog).hStopClick)
                End With
...
#Region "Tree"
    ...
    Public Overrides ReadOnly Property thisIcon As Dictionary(Of String, Icon)
        Get
            ...
            ret.Add(Name, My.Resources.events)
            Return ret
        End Get
    End Property
